...
<%
      ...
      //table5	
				...
				String personname=request.getParameter("personname");
       			...
       			String query="insert into fieldexecutivesheet(username,day,date,to1,subject,description,flag) values('"+username+"','"+day+"','"+date+"','"+to1+"','"+subject+"','"+description+"','"+flag+"')";
				...
				int insert=0;
          		insert= st.executeUpdate();
       			...
       			String quer="insert into marketing(username1,day1,date1,personalvisit,telemarketing,callreceived) values('"+username+"','day','date','personalvisit','telemarketing','callreceived')";
