			...
			//		ResultSet rs = st.executeQuery(query);
              ...
              /* while(rs.next())
			   ...
			   description=rs.getString(1);
				...
				<tr>
				<td width="124"><span class="style3">To </span></td>
				<td width="600">
...
<tr>
	  ...
	  <td>
				...
				<span class="style5">DD/MM/YYYY</span><a href="javascript:NewCal('date','ddmmyyyy')"> <img src="calendar.gif" alt="gr"></a></td>
				</tr>
<tr>
				<td><span class="style3">
				Day
      ...
      <option>Sunday</option>
			...
			Description
				...
				<td>
				<textarea  name="description" cols="76" rows="20" style="size:auto">
